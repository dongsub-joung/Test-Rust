...
impl Snake {
    pub fn new(width: u32, height: u32) -> Snake{
        let head_x: u32= stdweb::unstable::TryInto::try_into(
            js! {return Math.floor(Math.random()* @{width} )})
            .unwrap();
        
        let head_y: u32= stdweb::unstable::TryInto::try_into(
        ...
        Snake { head, tail, food, height, width, direction: None, next_direction: None, last_direction: Direction::Right }
    }
