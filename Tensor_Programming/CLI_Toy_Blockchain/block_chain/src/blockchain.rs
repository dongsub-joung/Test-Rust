...
use std::{fmt::Write, os::unix::prelude::OsStrExt};
...
impl Chain {
    ...
    pub fn generate_new_block(&mut self) -> bool {
        ...
        let reward_trans= Transaction{
            ...
            reciever: self.moner_addr.clone(),
            amount: self.reward
        }
        ...
        Cahin::prrof_of_work(&mut block.header);
    ...
    pub fn proof_of_work(header: &mut Blockheader){
        loop {
            ...
            let slice= &hash[..header.defficulty as usize];
